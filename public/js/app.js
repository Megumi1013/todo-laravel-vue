...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
      ...
      switch (this.activeFilter) {
        case 'completed':
          return this.todos.filter(function (todo) {
            //filter?
            return todo.state && !todo.trashed; // return todo.state === true;
          });
  ...
  methods: {
    ...
    changeState: function changeState(todoItem) {
    ...
    removeItem: function removeItem(todoItem) {
      var index = this.todos.indexOf(todoItem);
      this.todos.splice(index, 1); // indexOf = find?
      // splice??
    },
    sortAll: function sortAll() {
      this.activeFilter = null;
    },
    sortCompleted: function sortCompleted() {
      this.activeFilter = 'completed';
    },
    sortTrashed: function sortTrashed() {
      this.activeFilter = 'trashed';
    },
    editItem: function editItem(todoItemIndex) {
    ...
    clearCompleted: function clearCompleted() {
      ...
      this.todos.forEach(function (todo, index) {
        if (todo.state) {
          that.$set(that.todos[index], 'trashed', true); // that.todos[index].trashed = true;
          // that.$forceUpdate();
          //$set?
        }
      });
  ...
  return _c("div", { staticClass: "container mx-auto" }, [
    _c("div", { staticClass: "container" }, [
      _c("div", { staticClass: "py-12" }, [
        _c("h1", { staticClass: "text-center text-5xl text-gray-600" }, [
      ...
      _vm._v(" "),
      _c("div", { staticClass: "my-4 max-w-xl mx-auto" }, [
        _c("ul", { staticClass: "flex justify-between" }, [
          _c(
            "li",
            {
              staticClass: "mr-8 text-gray-500 align-middle cursor-pointer",
              on: { click: _vm.sortAll }
            },
            [
          ...
          _c(
            "li",
            {
              staticClass: "text-gray-500 align-middle cursor-pointer",
              on: { click: _vm.sortTrashed }
            },
            [
              _c("i", { staticClass: "material-icons" }, [
                _vm._v(
          ...
          _c(
            "li",
            {
              staticClass: "ml-auto text-gray-500 align-middle cursor-pointer",
      ...
      _c(
        "div",
        {
          staticClass: "my-4 p-6 max-w-xl mx-auto bg-white rounded-xl shadow-md"
        },
        _vm._l(_vm.filteredTodos, function(todoItem, todoItemIndex) {
          return _c("div", { staticClass: "flex items-center py-3" }, [
            _c("div", { staticClass: "flex items-center mr-auto w-full" }, [
              _c("div", { staticClass: "flex-1" }, [
                _c(
                  "label",
                  {
                    staticClass:
                      "bg-white border-2 rounded-full border-gray-200 w-8 h-8 flex flex-shrink-0 justify-center items-center mr-4 focus-within:border-blue-300",
                    attrs: { for: "checkBox" }
                  },
                  [
                    _c("input", {
                      staticClass: "opacity-0 absolute cursor-pointer w-8 h-8",
                      attrs: { id: "checkBox" },
                      on: {
                        click: function($event) {
                          return _vm.changeState(todoItem)
                        }
                      }
                    }),
                    _vm._v(" "),
                        ...
                        directives: [
                          {
                            ...
                            expression: "todoItem.state"
                          }
                        ],
                        staticClass: "fill-current w-4 h-4 text-blue-500",
              ...
              _c("div", { staticClass: "w-full" }, [
                _vm.activeItemEditIndex !== todoItemIndex
                  ? _c("div", [
                      _vm._v(
                        "\n                                         " +
                          _vm._s(todoItem.name) +
                          "\n                                     "
                      )
                    ])
                  : _c("div", [
                        ...
                        directives: [
                          {
                            ...
                            rawName: "v-model",
                            value: todoItem.name,
                            expression: "todoItem.name"
                          }
                        ],
                        staticClass:
                          "outline-none border-b-2 border-fuchsia-600 w-11/12",
                        attrs: { type: "text" },
                        domProps: { value: todoItem.name },
                        on: {
                          input: function($event) {
                            if ($event.target.composing) {
                              return
                            }
                            _vm.$set(todoItem, "name", $event.target.value)
                          }
                        }
                      })
                    ])
            ...
            _c("div", { staticClass: "flex items-center" }, [
              _vm.activeItemEditIndex === todoItemIndex
                ? _c(
                    ...
                    {
                      staticClass:
                        "mr-3 bg-yellow-300 rounded h-8 w-8 flex items-center justify-center",
                      on: {
                        click: function($event) {
                          _vm.activeItemEditIndex = null
                        }
                      }
                    },
                    [
              ...
              _vm.activeItemEditIndex !== todoItemIndex
                ? _c(
                    ...
                    {
                      staticClass:
                        "mr-3 bg-blue-300 rounded h-8 w-8 flex items-center justify-center",
                      on: {
                        click: function($event) {
                          return _vm.editItem(todoItemIndex)
                        }
                      }
                    },
                    [
              ...
              _c(
                ...
                {
                  staticClass:
                    "bg-gray-300 rounded h-8 w-8 flex items-center justify-center",
                  on: {
                    click: function($event) {
                      return _vm.removeItem(todoItem)
                    }
                  }
                },
                [
